...
- [Configuration](#configuration)
  ...
  - [GitHub PAT (recommended)](#using-a-github-pat-recommended)
  - [GitHub App / repo secret (`GITHUB_TOKEN`)](#using-a-github-app-or-repo-secret-github_token)
  - [Docker secrets (`_FILE`)](#using-docker-secrets-_file-variants)
...
- [Application setup notes](#application-setup-notes)
  ...
  - [Docker-in-Docker](#docker-in-docker-container-based-jobs)
  - [Custom packages / init scripts](#custom-packages--init-scripts)
  - [Non-root mode](#non-root-mode-lsio---user)
